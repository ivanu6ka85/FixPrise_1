class Locators:
    ...
    invalidUsername_message_xpath = '//div[@class="form-line auth-result"]/text()'
    invalidPassword_message_xpath = '//div[@class="form-line auth-result"]/text()'
    invalidUsernameAndPassword_xpath = '//div[@class="form-line auth-result"]/text()'

    # home page objects
    welcome_xpath = '//div[@class="personal-info__greeting"]'
    click_my_tabs_xpath = '//*[@id="favoritesCounter"]'
    my_basket_xpath = '//*[@id="basketCounter"]'
